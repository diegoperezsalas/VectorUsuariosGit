package com.diegoperezsalas.usuariosgit;
...
public class ItemAdapter extends RecyclerView.Adapter<ItemAdapter.ItemAdapter.ViewHolder> {
    ...
    @Override
    public class ItemAdapter, ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i){
